...
![img](http://img.zhufengpeixun.cn/eventloop2.png)
...
- 宏任务结束之后会先执行微任务 ```js setTimeout(() => { console.log(1); Promise.resolve(3).then(data => console.log(data)) }, 0)
...
![img](http://img.zhufengpeixun.cn/requestAnimationFrame.jpg)
...
![img](http://img.zhufengpeixun.cn/farmeimage.png)
...
![img](http://img.zhufengpeixun.cn/idlecallback.png)
...
![img](http://img.zhufengpeixun.cn/nodelibuv.jpg)
