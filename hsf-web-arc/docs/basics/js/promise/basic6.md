...
**iterable**可迭代对象，类似`[Array](<https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Array>)`。详见 [iterable](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/iterable)。
